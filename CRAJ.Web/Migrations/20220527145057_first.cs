    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConseilJudiciaire", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tribunal_ConseilJudiciaire_ConseilJudiciaireId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ConseilJudiciaire_ConseilJudiciaireId",
                        column: x => x.ConseilJudiciaireId,
                        principalTable: "ConseilJudiciaire",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tribunal_TribunalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Document_Chambre_ChambreId",
                        column: x => x.ChambreId,
                        principalTable: "Chambre",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Document_Tribunal_TribunalId",
                        column: x => x.TribunalId,
                        principalTable: "Tribunal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ConseilJudiciaireId",
                table: "AspNetUsers",
                column: "ConseilJudiciaireId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TribunalId",
                table: "AspNetUsers",
                column: "TribunalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Document_ChambreId",
                table: "Document",
                column: "ChambreId");

            migrationBuilder.CreateIndex(
                name: "IX_Document_TribunalId",
                table: "Document",
                column: "TribunalId");

            migrationBuilder.CreateIndex(
                name: "IX_Document_TypeDocuementId",
                table: "Document",
